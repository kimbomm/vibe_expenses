...
1. ⏳ 가계부 공유 및 초대
2. ⏳ 고급 필터링 및 검색
3. ✅ 차트 시각화 (Recharts) - 대시보드에 통합 완료
4. ⏳ 추가 차트 (월별 트렌드, 지출방법별 분석)
...
- 날짜: 2024-11-25
- 버전: 1.1.0
- 상태: Phase 2 완료, 대시보드 및 통계 통합 완료, Phase 3 준비 중
...
- 가계부별 대시보드 (`/ledgers/:id/dashboard`)
- 년도/월 필터링 기능
- 통계 및 차트 통합 (별도 통계 페이지 불필요)
- 카테고리별 지출 파이 차트
- 카테고리별 지출 상세 분석
