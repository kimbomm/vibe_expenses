      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          {members.map((member) => (
            <div
              key={member.userId}
              className="flex flex-row items-center justify-between gap-3 rounded-lg border p-4"
            >
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            {ledgerPendingInvitations.map((invitation) => (
              <div
                key={invitation.id}
                className="flex flex-row items-center justify-between gap-3 rounded-lg border border-dashed p-4"
              >
                <div className="flex items-center gap-3">
