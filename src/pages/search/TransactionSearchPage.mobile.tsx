...
export function TransactionSearchPageMobile() {
  ...
  return (
    <div className="space-y-5">
      <div className="rounded-2xl border bg-gradient-to-r from-emerald-50 via-background to-cyan-50 p-5">
        <h1 className="text-2xl font-bold">거래 검색</h1>
      ...
      <div className="rounded-2xl border bg-card p-4 shadow-sm">
        ...
        <div className="mt-4 flex flex-col gap-2">
          <Button className="w-full" onClick={runSearch} disabled={loading || !ledgerId}>
            {loading ? (
              <>
